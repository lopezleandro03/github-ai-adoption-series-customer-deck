          ...
          <div className={styles.left}>
            <div className={styles.card}>
              ...
              <ul className={styles.bulletList}>
                ...
                <li>Rotating speakers: GitHub &amp; Microsoft Engineers and Leaders</li>
              </ul>
            </div>
              ...
              <div className={styles.agendaRows}>
                <div className={styles.agendaRow}>
                  ...
                  <div className={styles.agendaContent}>
                    <h4>Hands-on Demo</h4>
                    <p>GitHub/Microsoft live demo on a focused topic — building hands-on agentic engineering skills</p>
                ...
                <div className={styles.agendaRow}>
                  ...
                  <div className={styles.agendaContent}>
                    ...
                    <p>Create opportunity for customer engineers to share best practices</p>
